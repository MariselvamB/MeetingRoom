...
class SignInDualPage_Page extends StatefulWidget {
  const SignInDualPage_Page({super.key, required String title});

  @override
  State<SignInDualPage_Page> createState() => _SignInDualPage_PageState();
}

class _SignInDualPage_PageState extends State<SignInDualPage_Page> {
                                        ...
                                        decoration: InputDecoration(
                                          prefix: Padding(
                                              padding: EdgeInsets.only(
                                                  left: 25, right: 20),
                                              child: Image.asset(
                                                  "Assets/ColorsSwatchImage.png",
                                                  fit: BoxFit.fill,
                                                  color: Colors.white)),
                                          border: InputBorder.none,
                                          counterText: '',
                                          hintText: "Select the Colour",
                                          hintStyle: TextStyle(
                                              decoration: TextDecoration.none,
                                              fontFamily: 'Lato',
                                              fontStyle: FontStyle.normal,
