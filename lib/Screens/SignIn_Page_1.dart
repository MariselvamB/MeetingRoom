...
import '../Models/sign_in/sign_in.api.json.dart';
                          ...
                          child: Column(
                            ...
                            children: [
                                  ...
                                  child: TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                        prefixIcon: Padding(
                                          ...
                                          child: IconButton(
                                            icon: Icon(_secureText ? Icons.lock_open : Icons.remove_red_eye, color: Colors.white),
                                            onPressed: () {
                                              setState(() {
                                  ...
                                  child: GestureDetector(
                                    onTap: () async {
                                      if (_formKey.currentState!.validate()) {
                                        ...
                                        SignIn? loginResponse = await NetworkService.signInpost(_UserNamecontroller.text, _passwordcontroller.text);
                                        if (loginResponse != null) {
                                          Navigator.push(
                                              context,
                                              MaterialPageRoute(
                                                builder: (context) => const RoseRoom(),
                                              ));
                                        } else {
                                          Get.showSnackbar(
                                            const GetSnackBar(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Container(
                                        ...
                                        decoration: const BoxDecoration(
                                          color: Color.fromRGBO(74, 108, 204, 1),
                              ...
                              Padding(
                                ...
                                child: GestureDetector(
                                  onTap: () {
                                    Navigator.push(context, MaterialPageRoute(builder: (context) => const RoseRoom()));
                                  },
                                  child: Container(
                                    width: double.infinity,
                                    decoration: BoxDecoration(
                                    ...
                                    child: Row(
                                      children: [
                                        Padding(
                                          ...
                                          child: Image.asset("Assets/icons_file-type-outlook.png"),
                                        ),
                                        Container(
                                          alignment: Alignment.center,
                                          child: const Text("Login with Outlook 360",
                                              style: TextStyle(
                                                  decoration: TextDecoration.none,
                                                  fontFamily: 'Montserrat',
                                                  fontStyle: FontStyle.normal,
                              ...
                              Center(
                                child: Container(
                                  padding: const EdgeInsets.only(top: 20, bottom: 10, left: 30, right: 45),
                                  alignment: Alignment.center,
