...
class homeScreenLockerPage extends StatefulWidget {
  const homeScreenLockerPage({super.key});

  @override
  State<homeScreenLockerPage> createState() => _homeScreenLockerPageState();
}

class _homeScreenLockerPageState extends State<homeScreenLockerPage> {
